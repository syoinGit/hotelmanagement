...
VALUES
  ('11111111-1111-1111-1111-111111111111', '佐藤花子', 'サトウハナコ', '女性', 28, '東京', 'hanako@example.com', '08098765432', 0, 'TEST'),
  ('22222222-2222-2222-2222-222222222222', '田中太郎', 'タナカタロウ', '男性', 35, '大阪', 'taro@example.com', '08011112222', 1 , 'TEST'),
  ('22222222-3333-3333-3333-222222222222', '山田毅', 'ヤマダタケシ', '男性', 40, '宮城', 'takeshi@example.com', '08033332222', 0 , 'statusTest');


INSERT INTO booking (id, name, description, price, is_available, user_id)
VALUES
  ('aaaaaaa1-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '朝食付きプラン', '和洋朝食が選べるプラン', 10000.00, 1, 'TEST'),
  ('aaaaaaa2-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '素泊まりプラン', '食事なし・シンプルステイ', 7000.00, 1, 'TEST');
